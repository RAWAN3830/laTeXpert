...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<RegistrationBlocCubit, RegistrationState>(
        ...
        builder: (context, state) {
          return state.map(
            initial: (_) => _buildForm(context, varHeight),
            loading: (_) => const Center(child: CircularProgressIndicator()),
            success: (_) => _buildForm(context, varHeight),
            failure: (_) => _buildForm(context, varHeight),
          );
        },
      ),
    );
  ...
  SingleChildScrollView _buildForm(BuildContext context, double varHeight) {
