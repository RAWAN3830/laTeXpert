    ...
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is AuthFailure) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text("${Strings.welcomeMessage} ${state.userName}!")),
          );
        }
      },
        ...
        if (state is AuthInitial) {
          ...
          return Center(
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("${Strings.welcomeMessage} ${state.userName}!"),
          ...
          return Center(child: Text("${Strings.errorMessage} ${state.errorMessage}"));
        }
