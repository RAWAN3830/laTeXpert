...
import 'package:latexpert/presentation/home_screen/template_selection_screen/template_selection_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            IconButton(
                onPressed: () {
                  context.push(context, target: const ProfileScreen());
                },
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildTopCards(
                            context, constraints, deviceType, screenHeight),
  ...
  Widget _buildTopCards(BuildContext context, BoxConstraints constraints,
      String deviceType, double screenHeight) {
        ...
        ? Row(
            ...
            children: [
              shimmerCardPlaceholder(
                  width: constraints.maxWidth * 0.45, height: cardHeight),
              shimmerCardPlaceholder(
                  width: constraints.maxWidth * 0.45, height: cardHeight),
            ],
          )
        : Row(
            ...
            children: [
              HomeScreenCard(
                ...
                onTap: () =>
                    context.push(context, target: const ResumeBuilderScreen()),
                height: cardHeight,
              ),
              HomeScreenCard(
                ...
                onTap: () =>
                    context.push(context, target: const TemplateSelectionScreen()),
                height: cardHeight,
              ),
            ],
          );
  ...
  Widget _buildMiddleCard(BuildContext context, BoxConstraints constraints,
      String deviceType, double screenHeight) {
    final cardHeight = deviceType == 'mobile'
    ...
    return _isLoading
        ? shimmerCardPlaceholder(
            width: constraints.maxWidth, height: cardHeight)
        : HomeScreenCard2(
  ...
  Widget _buildBottomCard(BuildContext context, BoxConstraints constraints,
      String deviceType, double screenHeight) {
    final cardHeight = deviceType == 'mobile'
